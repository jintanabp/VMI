 ...
 * เพดานความยาวเลข PO
 *
 * **รูปแบบเลขของเรายืนยันแล้วเมื่อ 11 ก.ย. 69 ว่าใช้กับ ERP ได้** —
 * `V1`–`V6` + `YYMMDD` + ลำดับของวัน (+ ตัวอักษรกลุ่มถ้าแบ่งใบ) เช่น `V126082801A`
 *
 * 12 ตัวเป็นกติกาที่**เราตั้งเอง**ตาม ocr-po-matching ไม่ใช่ของปลายทาง —
 * คอลัมน์จริงเป็น `ORDERNO VARCHAR2(20)` · เก็บไว้แคบกว่าโดยตั้งใจเพื่อให้เลขอ่านออกด้วยตา
 */

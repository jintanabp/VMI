...
CREATE TABLE "new_OrderItem" (
    ...
    "qtyIncreasePendingConfirm" BOOLEAN NOT NULL DEFAULT false,
    "cvdEstimate" REAL,
    "minDays" INTEGER,
    "maxDays" INTEGER,
...
INSERT INTO "new_OrderItem" ("c4DiscountBaht", "c4DiscountPct", "c4FreeGoodCode", "c4FreeGoodName", "c4FreeGoodQty", "c4FreeGoodUnit", "c4NetUnitPrice", "c4PooledQty", "c4PriceExpired", "c4PromoGroup", "c4PromoGroupMembers", "c4PromoKind", "c4PromoLabel", "c4UnitPrice", "cvdEstimate", "discountFlagReason", "discountFlagged", "finalQty", "id", "maxDays", "minDays", "orderId", "poGroup", "priceFlagReason", "priceFlagged", "purchaseOrderId", "rejectReason", "rejectedAt", "requestedQty", "salesPriceAt", "salesPriceBy", "salesPriceOverride", "skuId", "suggestedQty", "unitPriceOverride") SELECT "c4DiscountBaht", "c4DiscountPct", "c4FreeGoodCode", "c4FreeGoodName", "c4FreeGoodQty", "c4FreeGoodUnit", "c4NetUnitPrice", "c4PooledQty", "c4PriceExpired", "c4PromoGroup", "c4PromoGroupMembers", "c4PromoKind", "c4PromoLabel", "c4UnitPrice", "cvdEstimate", "discountFlagReason", "discountFlagged", "finalQty", "id", "maxDays", "minDays", "orderId", "poGroup", "priceFlagReason", "priceFlagged", "purchaseOrderId", "rejectReason", "rejectedAt", "requestedQty", "salesPriceAt", "salesPriceBy", "salesPriceOverride", "skuId", "suggestedQty", "unitPriceOverride" FROM "OrderItem";
